...
const functions = {
    setActiveInstanceToDevnet: async (args)=>{
        const Network = o1js__WEBPACK_IMPORTED_MODULE_0__/* .Mina */ .No.Network("https://api.minascan.io/node/devnet/v1/graphql");
        console.log("Devnet network instance configured.");
        o1js__WEBPACK_IMPORTED_MODULE_0__/* .Mina */ .No.setActiveInstance(Network);
    },
    loadContract: async (args)=>{
        const { Add } = await __webpack_require__.e(/* import() */ 189).then(__webpack_require__.bind(__webpack_require__, 189));
        state.Add = Add;
    },
    ...
    createUpdateTransaction: async (args)=>{
        const transaction = await o1js__WEBPACK_IMPORTED_MODULE_0__/* .Mina */ .No.transaction(async ()=>{
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [674], function() { return __webpack_require__(6134); })
...
/******/ 			if (chunkId === 674) return "static/chunks/982f5ae2-065c2bdbba399b1e.js";
/******/ 			// return url for filenames based on template
/******/ 			return "static/chunks/" + chunkId + "." + "f8abfda1665c507f" + ".js";
/******/ 		};
/******/ 	}();
/******/ 	
